...
loc1 = Location.create({
  ...
  image: "http://res.cloudinary.com/dazguin0y/image/upload/v1457074848/zycsyabhpowovd0n2eth.jpg",
  ...
  price: 75})
loc2 = Location.create({title: "fdsofih", lat: 37.5, lng: -122.44, description: "Burritos and crap.", occupancy: 5, address: "jio", city: "jiof", state: "CA", zip_code: "90623", full_address: "address_here", price: 80, image: "http://res.cloudinary.com/dazguin0y/image/upload/v1457074848/zycsyabhpowovd0n2eth.jpg"})
